                ...
                children: [
                  ...
                  SizedBox(
                    ...
                    child: OutlinedButton(
                      onPressed: () async {
                        unawaited(_playSfx('sfx_button.ogg'));
                        await _progressService.setUnlockedLevel(3);
                        Navigator.of(dialogContext).pop();
